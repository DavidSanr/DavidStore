namespace BabyStore.Migrations.StoreConfiguration
{
    ...
    internal sealed class StoreConfiguration : DbMigrationsConfiguration<DavidStore.DAL.StoreContext>
    {
        ...
        protected override void Seed(DavidStore.DAL.StoreContext context)
        {
